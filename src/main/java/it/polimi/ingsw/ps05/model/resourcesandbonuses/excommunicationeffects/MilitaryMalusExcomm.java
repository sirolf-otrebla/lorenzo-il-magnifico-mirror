...
public class MilitaryMalusExcomm extends PermanentBonus implements ExcommunicationEffect {
	...
	public String toString(){
		...
		return "Ogni volta che guadagni x punti militare ne prendi " + forRes;
	}
