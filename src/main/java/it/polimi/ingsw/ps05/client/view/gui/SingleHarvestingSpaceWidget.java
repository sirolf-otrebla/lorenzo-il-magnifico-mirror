 ...
 */
public class SingleHarvestingSpaceWidget extends SingleOccupantActionSpaceWidget {

    private PlayerWidget player;
    ArrayList<Integer> selectedActivations = new ArrayList<>();

    public SingleHarvestingSpaceWidget(int minDie, PlayerWidget player) {
        super(minDie);
        this.player = player;
    }
